class Hero:
    ...
    def battle(self, enemy_hero):
        ...
        player_damage = self.damage * self.level #100
        enemy_hero_damage = enemy_hero.damage * enemy_hero.level #100

        self.health -= enemy_hero_damage #100 -= 100 = 0
        enemy_hero.health -= player_damage #50 -= 100 = -50
