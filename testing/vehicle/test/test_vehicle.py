...
class TestVehicle(TestCase):
    ...
    def test_default_consumption_class_attributes_is_currect(self):
        self.assertTrue(1.25, self.vehicle.DEFAULT_FUEL_CONSUMPTION)

    def test_correct_initializing(self):
        self.assertTrue(20.5, self.vehicle.fuel)
        self.assertTrue(175.5, self.vehicle.horse_power)
    ...
    def test_drive_with_enough_fuel_decrease(self):
        self.vehicle.drive(2)
        self.assertEqual(18, self.vehicle.fuel)

    def test_refuel_full_car_raises_exeption(self):
        with self.assertRaises(Exception) as ex:
